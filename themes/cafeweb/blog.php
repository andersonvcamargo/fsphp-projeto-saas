...
<section class="blog_page">
    <header class="blog_page_header">
        ...
        <form name="search" action="/fsphp-projeto-mvc/blog/buscar" method="post" enctype="multipart/form-data">
            <label>
    ...
    <div class="content content">
            <div class="empty_content">
                ...
                <p class="empty_content_desc">Nossos editores estão preparando um tentúdo de primeira para você</p>
            </div>
        </div>
    <?php else: ?>
